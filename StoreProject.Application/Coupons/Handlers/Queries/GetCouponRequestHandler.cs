...
{
    public class GetCouponRequestHandler : IRequestHandler<GetCouponRequest, DiscountDto>
    {
        ...
        public async Task<DiscountDto> Handle(GetCouponRequest request, CancellationToken cancellationToken)
        {
