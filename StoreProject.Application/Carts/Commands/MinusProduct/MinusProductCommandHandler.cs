...
{
    public class MinusProductCommandHandler : IRequestHandler<MinusProductCommand, Unit>
    {
        ...
        public MinusProductCommandHandler(ICartItemRepository cartItemRepository, ICartRepository cartRepository, IJwtService jwtService, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Unit> Handle(MinusProductCommand request, CancellationToken cancellationToken)
        {
